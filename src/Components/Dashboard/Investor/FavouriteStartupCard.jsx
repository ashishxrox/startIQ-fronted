...
const gradientPresets = [
  "bg-gradient-to-r from-[#6EE7B7] via-[#3B82F6] to-[#9333EA]", // green-blue-purple
  "bg-gradient-to-r from-[#FBBF24] via-[#F97316] to-[#EF4444]", // yellow-orange-red
  "bg-gradient-to-r from-[#60A5FA] via-[#818CF8] to-[#C084FC]", // blue-purple
];

const FavouriteStartupCard = ({ startup, index }) => {
...
export default FavouriteStartupCard;
